...
cat > "$TMP_DIR/.output/domain/quanx/sample.list" <<'RULES'
HOST,api.example.com,sample
HOST-SUFFIX,example.com,sample
HOST-KEYWORD,example,sample
HOST-REGEX,^example$,sample
RULES

...
| domain/category-ai-chat-!cn.list | 181 |
...
| domain/facebook.list | 395 |
| domain/fakeip-filter.list | 87 |
| domain/geolocation-!cn.list | 23746 |
| domain/geolocation-!cn@cn.list | 598 |
| domain/github.list | 59 |
| domain/google-gemini.list | 43 |
| domain/google.list | 847 |
